...
Route::prefix('purchases')->group(function () {
    Route::get('/', [PurchasesController::class, 'index'])->name('purchase.index'); // Purchase list view
    Route::get('/purchases/products', [PurchasesController::class, 'getProducts'])->name('purchase.products');
    Route::get('/datatable', [PurchasesController::class, 'datatable'])->name('purchase.datatable'); // DataTable API
    Route::post('/store', [PurchasesController::class, 'store'])->name('purchase.store'); // Store a new purchase
    Route::get('/edit/{id}', [PurchasesController::class, 'edit'])->name('purchase.edit'); // Edit purchase data
    Route::post('/update/{id}', [PurchasesController::class, 'update'])->name('purchase.update'); // Update purchase
    Route::delete('/delete/{id}', [PurchasesController::class, 'destroy'])->name('purchase.delete'); // Delete purchase
});
