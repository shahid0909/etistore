...
class RefundableProduct extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $units = Unit::all();
        $products = Product::with('category', 'subcategory', 'unit', 'inventory')->where('is_returnable', 1)->get();

        return view('backend.pages.refundable_product.index', compact('categories', 'subcategories', 'units', 'products'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $product->is_returnable = 1; // Default to false
    ...
    public function datatable()
    {
        try {
            ...
            $data = Product::with('category', 'subcategory', 'unit','inventory')->where('is_returnable', 1)->orderBy('id', 'desc')->get();
