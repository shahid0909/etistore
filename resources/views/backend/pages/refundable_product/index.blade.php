    ...
    <script>
        $(document).ready(function() {
            ...
            let productTable = $('#product-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route("refundableproduct.datatable") }}',
            ...
            function fetchSubcategories(categoryId) {
                ...
                if (categoryId) {
                    $.ajax({
                        url: '{{ route("refundableproduct.subcategories") }}',
                        type: 'GET',
                        data: {
            ...
            $('#product-form').submit(function(e) {
                ...
                $.ajax({
                    url: '{{ route("refundableproduct.store") }}',
                    method: 'POST',
                    data: $(this).serialize(),
                    beforeSend: function() {
            ...
            $(document).on('click', '.edit-btn', function() {
                let id = $(this).data('id');
                $.get('{{ route("refundableproduct.edit", "") }}/' + id, function(data) {
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                if (confirm('Are you sure to delete this product?')) {
                    $.ajax({
                        url: '{{ route("refundableproduct.delete", "") }}/' + id,
                        method: 'DELETE',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
